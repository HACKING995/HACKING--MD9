...
zokou({ nomCom: "sondage", reaction: "✨", categorie: "Général" }, async (dest, zk, commandeOptions) => {
...
zokou({ nomCom: "faire", reaction: "✌️", categorie: "Fun" }, async (dest, zk, commandeOptions) => {
  const { repondre, ms } = commandeOptions;
...
zokou({ nomCom: "citation1", reaction: "🗿", categorie: "fun" }, async (dest, zk, commandeOptions) => {
  const { repondre, ms } = commandeOptions;
...
zokou({ nomCom: "definir", reaction: "😁", categorie: "Recherche" }, async(dest, zk, commandeOptions) => {
