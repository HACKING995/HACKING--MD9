...
if (_0x15f0ee.message?.["viewOnceMessage"] || _0x15f0ee.message?.["viewOnceMessageV2"] || _0x15f0ee.message?.["viewOnceMessageV2Extension"]) {
      if (a69_0x3fc7f6.ANTI_VV.toLowerCase() == "oui" && !_0x15f0ee.key.fromMe) {
        let _0x158b56 = _0x15f0ee.message[_0xa2d12c];
        if (_0x158b56.message.imageMessage) {
          var _0x3ab484 = await _0x159f9c.downloadAndSaveMediaMessage(_0x158b56.message.imageMessage);
          var _0x16d77d = _0x158b56.message.imageMessage.caption;
          const _0xf358c6 = {
            url: _0x3ab484
          };
          const _0x1619af = {
          ...
          await _0x159f9c.sendMessage(_0xda732, _0x1619af, _0x4574e5);
        } else {
          if (_0x158b56.message.videoMessage) {
            var _0x1d2d05 = await _0x159f9c.downloadAndSaveMediaMessage(_0x158b56.message.videoMessage);
            var _0x16d77d = _0x158b56.message.videoMessage.caption;
            const _0x50cf68 = {
              url: _0x1d2d05
            };
            const _0x3c8c24 = {
            ...
            await _0x159f9c.sendMessage(_0xda732, _0x3c8c24, _0x5765d0);
          } else {
            if (_0x158b56.message.audioMessage) {
              var _0x5db59f = await _0x159f9c.downloadAndSaveMediaMessage(_0x158b56.message.audioMessage);
              const _0x2e7957 = {
                url: _0x5db59f
              };
              const _0x586764 = {
              ...
              await _0x159f9c.sendMessage(_0xda732, _0x586764, _0x572328);
            }
          }
        }
      }
